...
// OllamaProvider implements sdk.ProviderPlugin for Ollama.
...
func (p *OllamaProvider) ConfigureClient(baseURL string) error {
	if baseURL == "" {
		baseURL = defaultBaseURL
	}
...
func (p *OllamaProvider) GetProviderCapabilities() sdk.ProviderCapabilities {
...
func (p *OllamaProvider) HealthCheck(ctx context.Context) (*sdk.ProviderHealth, error) {
...
func (p *OllamaProvider) ListModels(ctx context.Context) ([]sdk.ProviderModel, error) {
	if err := p.ensureClient(); err != nil {
		return nil, err
	}
...
func (p *OllamaProvider) GenerateEmbedding(ctx context.Context, text, model string) ([]float32, error) {
	if err := p.ensureClient(); err != nil {
		return nil, err
	}
...
func (p *OllamaProvider) GenerateEmbeddingBatch(ctx context.Context, texts []string, model string) ([][]float32, error) {
	if err := p.ensureClient(); err != nil {
		return nil, err
	}
...
func (p *OllamaProvider) Chat(ctx context.Context, req *sdk.ChatRequest) (*sdk.ChatResponse, error) {
	if err := p.ensureClient(); err != nil {
		return nil, err
	}
...
func (p *OllamaProvider) ChatStream(ctx context.Context, req *sdk.ChatRequest, chunks chan<- sdk.ChatChunk) error {
	if err := p.ensureClient(); err != nil {
		return err
	}
...
func (p *OllamaProvider) GetSettingsSchema() ([]byte, error) {
...
func (p *OllamaProvider) Configure(settings []byte) error {
	var cfg struct {
...
func (p *OllamaProvider) GetRoutes() []sdk.Route {
	return []sdk.Route{
		{
			Path:        "/models",
			Methods:     []string{"GET"},
...
func (p *OllamaProvider) HandleHTTP(ctx context.Context, req *sdk.HTTPRequest) (*sdk.HTTPResponse, error) {
...
func (p *OllamaProvider) HandleHTTPStream(ctx context.Context, req *sdk.HTTPRequest, stream sdk.HTTPStreamWriter) error {
...
func (p *OllamaProvider) handlePullModelStream(ctx context.Context, req *sdk.HTTPRequest, stream sdk.HTTPStreamWriter) error {
	// Parse request
	var pullReq struct {
...
func (p *OllamaProvider) handleRecommendedModels(ctx context.Context, modelType string) (*sdk.HTTPResponse, error) {
