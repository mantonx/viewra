...
const file_pkg_plugins_proto_plugin_proto_rawDesc = "" +
	...
	"\x05error\x18\x03 \x01(\tR\x05error\"\xe1\x04\n" +
	...
	"\x05speed\x18\t \x01(\x01R\x05speed2\xa9\x02\n" +
	"\rPluginService\x12C\n" +
	"\n" +
	...
	"\x12GetTranscodeStream\x12!.plugin.GetTranscodeStreamRequest\x1a\x1c.plugin.TranscodeStreamChunk0\x01B-Z+github.com/mantonx/viewra/pkg/plugins/protob\x06proto3"
...
var file_pkg_plugins_proto_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 77)
var file_pkg_plugins_proto_plugin_proto_goTypes = []any{
	...
	nil,                                   // 68: plugin.SaveAssetRequest.MetadataEntry
	nil,                                   // 69: plugin.SearchRequest.QueryEntry
	nil,                                   // 70: plugin.SearchResult.MetadataEntry
	nil,                                   // 71: plugin.ExtractMetadataResponse.MetadataEntry
	nil,                                   // 72: plugin.OnMediaFileScannedRequest.MetadataEntry
	nil,                                   // 73: plugin.OnScanCompletedRequest.StatsEntry
	nil,                                   // 74: plugin.PluginContext.ConfigEntry
	nil,                                   // 75: plugin.TranscodeRequest.OptionsEntry
	nil,                                   // 76: plugin.TranscodeSession.MetadataEntry
}
var file_pkg_plugins_proto_plugin_proto_depIdxs = []int32{
	...
	68, // 1: plugin.SaveAssetRequest.metadata:type_name -> plugin.SaveAssetRequest.MetadataEntry
	69, // 2: plugin.SearchRequest.query:type_name -> plugin.SearchRequest.QueryEntry
	11, // 3: plugin.SearchResponse.results:type_name -> plugin.SearchResult
	70, // 4: plugin.SearchResult.metadata:type_name -> plugin.SearchResult.MetadataEntry
	...
	71, // 7: plugin.ExtractMetadataResponse.metadata:type_name -> plugin.ExtractMetadataResponse.MetadataEntry
	72, // 8: plugin.OnMediaFileScannedRequest.metadata:type_name -> plugin.OnMediaFileScannedRequest.MetadataEntry
	73, // 9: plugin.OnScanCompletedRequest.stats:type_name -> plugin.OnScanCompletedRequest.StatsEntry
	48, // 10: plugin.GetAdminPagesResponse.pages:type_name -> plugin.AdminPageConfig
	74, // 11: plugin.PluginContext.config:type_name -> plugin.PluginContext.ConfigEntry
	...
	75, // 19: plugin.TranscodeRequest.options:type_name -> plugin.TranscodeRequest.OptionsEntry
	...
	76, // 23: plugin.TranscodeSession.metadata:type_name -> plugin.TranscodeSession.MetadataEntry
	14, // 24: plugin.PluginService.Initialize:input_type -> plugin.InitializeRequest
	16, // 25: plugin.PluginService.Start:input_type -> plugin.StartRequest
	18, // 26: plugin.PluginService.Stop:input_type -> plugin.StopRequest
	20, // 27: plugin.PluginService.Info:input_type -> plugin.InfoRequest
	22, // 28: plugin.PluginService.Health:input_type -> plugin.HealthRequest
	24, // 29: plugin.MetadataScraperService.CanHandle:input_type -> plugin.CanHandleRequest
	26, // 30: plugin.MetadataScraperService.ExtractMetadata:input_type -> plugin.ExtractMetadataRequest
	28, // 31: plugin.MetadataScraperService.GetSupportedTypes:input_type -> plugin.GetSupportedTypesRequest
	30, // 32: plugin.ScannerHookService.OnMediaFileScanned:input_type -> plugin.OnMediaFileScannedRequest
	32, // 33: plugin.ScannerHookService.OnScanStarted:input_type -> plugin.OnScanStartedRequest
	34, // 34: plugin.ScannerHookService.OnScanCompleted:input_type -> plugin.OnScanCompletedRequest
	3,  // 35: plugin.AssetService.SaveAsset:input_type -> plugin.SaveAssetRequest
	5,  // 36: plugin.AssetService.AssetExists:input_type -> plugin.AssetExistsRequest
	7,  // 37: plugin.AssetService.RemoveAsset:input_type -> plugin.RemoveAssetRequest
	36, // 38: plugin.DatabaseService.GetModels:input_type -> plugin.GetModelsRequest
	38, // 39: plugin.DatabaseService.Migrate:input_type -> plugin.MigrateRequest
	40, // 40: plugin.DatabaseService.Rollback:input_type -> plugin.RollbackRequest
	42, // 41: plugin.AdminPageService.GetAdminPages:input_type -> plugin.GetAdminPagesRequest
	44, // 42: plugin.AdminPageService.RegisterRoutes:input_type -> plugin.RegisterRoutesRequest
	1,  // 43: plugin.APIRegistrationService.GetRegisteredRoutes:input_type -> plugin.GetRegisteredRoutesRequest
	9,  // 44: plugin.SearchService.Search:input_type -> plugin.SearchRequest
	12, // 45: plugin.SearchService.GetSearchCapabilities:input_type -> plugin.GetSearchCapabilitiesRequest
	51, // 46: plugin.TranscodingService.GetCapabilities:input_type -> plugin.GetCapabilitiesRequest
	53, // 47: plugin.TranscodingService.StartTranscode:input_type -> plugin.StartTranscodeRequest
	55, // 48: plugin.TranscodingService.GetTranscodeSession:input_type -> plugin.GetTranscodeSessionRequest
	57, // 49: plugin.TranscodingService.StopTranscode:input_type -> plugin.StopTranscodeRequest
	59, // 50: plugin.TranscodingService.ListActiveSessions:input_type -> plugin.ListActiveSessionsRequest
	61, // 51: plugin.TranscodingService.GetTranscodeStream:input_type -> plugin.GetTranscodeStreamRequest
	15, // 52: plugin.PluginService.Initialize:output_type -> plugin.InitializeResponse
	17, // 53: plugin.PluginService.Start:output_type -> plugin.StartResponse
	19, // 54: plugin.PluginService.Stop:output_type -> plugin.StopResponse
	21, // 55: plugin.PluginService.Info:output_type -> plugin.InfoResponse
	23, // 56: plugin.PluginService.Health:output_type -> plugin.HealthResponse
	25, // 57: plugin.MetadataScraperService.CanHandle:output_type -> plugin.CanHandleResponse
	27, // 58: plugin.MetadataScraperService.ExtractMetadata:output_type -> plugin.ExtractMetadataResponse
	29, // 59: plugin.MetadataScraperService.GetSupportedTypes:output_type -> plugin.GetSupportedTypesResponse
	31, // 60: plugin.ScannerHookService.OnMediaFileScanned:output_type -> plugin.OnMediaFileScannedResponse
	33, // 61: plugin.ScannerHookService.OnScanStarted:output_type -> plugin.OnScanStartedResponse
	35, // 62: plugin.ScannerHookService.OnScanCompleted:output_type -> plugin.OnScanCompletedResponse
	4,  // 63: plugin.AssetService.SaveAsset:output_type -> plugin.SaveAssetResponse
	6,  // 64: plugin.AssetService.AssetExists:output_type -> plugin.AssetExistsResponse
	8,  // 65: plugin.AssetService.RemoveAsset:output_type -> plugin.RemoveAssetResponse
	37, // 66: plugin.DatabaseService.GetModels:output_type -> plugin.GetModelsResponse
	39, // 67: plugin.DatabaseService.Migrate:output_type -> plugin.MigrateResponse
	41, // 68: plugin.DatabaseService.Rollback:output_type -> plugin.RollbackResponse
	43, // 69: plugin.AdminPageService.GetAdminPages:output_type -> plugin.GetAdminPagesResponse
	45, // 70: plugin.AdminPageService.RegisterRoutes:output_type -> plugin.RegisterRoutesResponse
	2,  // 71: plugin.APIRegistrationService.GetRegisteredRoutes:output_type -> plugin.GetRegisteredRoutesResponse
	10, // 72: plugin.SearchService.Search:output_type -> plugin.SearchResponse
	13, // 73: plugin.SearchService.GetSearchCapabilities:output_type -> plugin.GetSearchCapabilitiesResponse
	52, // 74: plugin.TranscodingService.GetCapabilities:output_type -> plugin.GetCapabilitiesResponse
	54, // 75: plugin.TranscodingService.StartTranscode:output_type -> plugin.StartTranscodeResponse
	56, // 76: plugin.TranscodingService.GetTranscodeSession:output_type -> plugin.GetTranscodeSessionResponse
	58, // 77: plugin.TranscodingService.StopTranscode:output_type -> plugin.StopTranscodeResponse
	60, // 78: plugin.TranscodingService.ListActiveSessions:output_type -> plugin.ListActiveSessionsResponse
	62, // 79: plugin.TranscodingService.GetTranscodeStream:output_type -> plugin.TranscodeStreamChunk
