...
const file_pkg_plugins_proto_plugin_proto_rawDesc = "" +
	...
	"\x11host_service_addr\x18\x06 \x01(\tR\x0fhostServiceAddr\x1a9\n" +
	...
	"\x15GetSearchCapabilities\x12$.plugin.GetSearchCapabilitiesRequest\x1a%.plugin.GetSearchCapabilitiesResponseB-Z+github.com/mantonx/viewra/pkg/plugins/protob\x06proto3"
...
var file_pkg_plugins_proto_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_pkg_plugins_proto_plugin_proto_goTypes = []any{
	...
	nil,                                   // 49: plugin.SaveAssetRequest.MetadataEntry
	nil,                                   // 50: plugin.SearchRequest.QueryEntry
	nil,                                   // 51: plugin.SearchResult.MetadataEntry
	nil,                                   // 52: plugin.ExtractMetadataResponse.MetadataEntry
	nil,                                   // 53: plugin.OnMediaFileScannedRequest.MetadataEntry
	nil,                                   // 54: plugin.OnScanCompletedRequest.StatsEntry
	nil,                                   // 55: plugin.PluginContext.ConfigEntry
}
var file_pkg_plugins_proto_plugin_proto_depIdxs = []int32{
	...
	49, // 1: plugin.SaveAssetRequest.metadata:type_name -> plugin.SaveAssetRequest.MetadataEntry
	50, // 2: plugin.SearchRequest.query:type_name -> plugin.SearchRequest.QueryEntry
	11, // 3: plugin.SearchResponse.results:type_name -> plugin.SearchResult
	51, // 4: plugin.SearchResult.metadata:type_name -> plugin.SearchResult.MetadataEntry
	...
	52, // 7: plugin.ExtractMetadataResponse.metadata:type_name -> plugin.ExtractMetadataResponse.MetadataEntry
	53, // 8: plugin.OnMediaFileScannedRequest.metadata:type_name -> plugin.OnMediaFileScannedRequest.MetadataEntry
	54, // 9: plugin.OnScanCompletedRequest.stats:type_name -> plugin.OnScanCompletedRequest.StatsEntry
	48, // 10: plugin.GetAdminPagesResponse.pages:type_name -> plugin.AdminPageConfig
	55, // 11: plugin.PluginContext.config:type_name -> plugin.PluginContext.ConfigEntry
	14, // 12: plugin.PluginService.Initialize:input_type -> plugin.InitializeRequest
	16, // 13: plugin.PluginService.Start:input_type -> plugin.StartRequest
	18, // 14: plugin.PluginService.Stop:input_type -> plugin.StopRequest
	20, // 15: plugin.PluginService.Info:input_type -> plugin.InfoRequest
	22, // 16: plugin.PluginService.Health:input_type -> plugin.HealthRequest
	24, // 17: plugin.MetadataScraperService.CanHandle:input_type -> plugin.CanHandleRequest
	26, // 18: plugin.MetadataScraperService.ExtractMetadata:input_type -> plugin.ExtractMetadataRequest
	28, // 19: plugin.MetadataScraperService.GetSupportedTypes:input_type -> plugin.GetSupportedTypesRequest
	30, // 20: plugin.ScannerHookService.OnMediaFileScanned:input_type -> plugin.OnMediaFileScannedRequest
	32, // 21: plugin.ScannerHookService.OnScanStarted:input_type -> plugin.OnScanStartedRequest
	34, // 22: plugin.ScannerHookService.OnScanCompleted:input_type -> plugin.OnScanCompletedRequest
	3,  // 23: plugin.AssetService.SaveAsset:input_type -> plugin.SaveAssetRequest
	5,  // 24: plugin.AssetService.AssetExists:input_type -> plugin.AssetExistsRequest
	7,  // 25: plugin.AssetService.RemoveAsset:input_type -> plugin.RemoveAssetRequest
	36, // 26: plugin.DatabaseService.GetModels:input_type -> plugin.GetModelsRequest
	38, // 27: plugin.DatabaseService.Migrate:input_type -> plugin.MigrateRequest
	40, // 28: plugin.DatabaseService.Rollback:input_type -> plugin.RollbackRequest
	42, // 29: plugin.AdminPageService.GetAdminPages:input_type -> plugin.GetAdminPagesRequest
	44, // 30: plugin.AdminPageService.RegisterRoutes:input_type -> plugin.RegisterRoutesRequest
	1,  // 31: plugin.APIRegistrationService.GetRegisteredRoutes:input_type -> plugin.GetRegisteredRoutesRequest
	9,  // 32: plugin.SearchService.Search:input_type -> plugin.SearchRequest
	12, // 33: plugin.SearchService.GetSearchCapabilities:input_type -> plugin.GetSearchCapabilitiesRequest
	15, // 34: plugin.PluginService.Initialize:output_type -> plugin.InitializeResponse
	17, // 35: plugin.PluginService.Start:output_type -> plugin.StartResponse
	19, // 36: plugin.PluginService.Stop:output_type -> plugin.StopResponse
	21, // 37: plugin.PluginService.Info:output_type -> plugin.InfoResponse
	23, // 38: plugin.PluginService.Health:output_type -> plugin.HealthResponse
	25, // 39: plugin.MetadataScraperService.CanHandle:output_type -> plugin.CanHandleResponse
	27, // 40: plugin.MetadataScraperService.ExtractMetadata:output_type -> plugin.ExtractMetadataResponse
	29, // 41: plugin.MetadataScraperService.GetSupportedTypes:output_type -> plugin.GetSupportedTypesResponse
	31, // 42: plugin.ScannerHookService.OnMediaFileScanned:output_type -> plugin.OnMediaFileScannedResponse
	33, // 43: plugin.ScannerHookService.OnScanStarted:output_type -> plugin.OnScanStartedResponse
	35, // 44: plugin.ScannerHookService.OnScanCompleted:output_type -> plugin.OnScanCompletedResponse
	4,  // 45: plugin.AssetService.SaveAsset:output_type -> plugin.SaveAssetResponse
	6,  // 46: plugin.AssetService.AssetExists:output_type -> plugin.AssetExistsResponse
	8,  // 47: plugin.AssetService.RemoveAsset:output_type -> plugin.RemoveAssetResponse
	37, // 48: plugin.DatabaseService.GetModels:output_type -> plugin.GetModelsResponse
	39, // 49: plugin.DatabaseService.Migrate:output_type -> plugin.MigrateResponse
	41, // 50: plugin.DatabaseService.Rollback:output_type -> plugin.RollbackResponse
	43, // 51: plugin.AdminPageService.GetAdminPages:output_type -> plugin.GetAdminPagesResponse
	45, // 52: plugin.AdminPageService.RegisterRoutes:output_type -> plugin.RegisterRoutesResponse
	2,  // 53: plugin.APIRegistrationService.GetRegisteredRoutes:output_type -> plugin.GetRegisteredRoutesResponse
	10, // 54: plugin.SearchService.Search:output_type -> plugin.SearchResponse
	13, // 55: plugin.SearchService.GetSearchCapabilities:output_type -> plugin.GetSearchCapabilitiesResponse
