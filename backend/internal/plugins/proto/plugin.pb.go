...
func (x *SaveAssetRequest) GetMediaFileId() uint32 {
	if x != nil {
...
func (x *AssetExistsRequest) GetMediaFileId() uint32 {
	if x != nil {
		return x.MediaFileId
	}
	return 0
...
func (x *PluginInfo) Reset() {
	*x = PluginInfo{}
	mi := &file_internal_plugins_proto_plugin_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PluginInfo) Descriptor() ([]byte, []int) {
	return file_internal_plugins_proto_plugin_proto_rawDescGZIP(), []int{47}
}
...
func (x *AdminPageConfig) Reset() {
	*x = AdminPageConfig{}
	mi := &file_internal_plugins_proto_plugin_proto_msgTypes[48]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdminPageConfig) Descriptor() ([]byte, []int) {
	return file_internal_plugins_proto_plugin_proto_rawDescGZIP(), []int{48}
}
...
const file_internal_plugins_proto_plugin_proto_rawDesc = "" +
	...
	"\x06routes\x18\x01 \x03(\v2\x10.plugin.APIRouteR\x06routes\"\xdc\x02\n" +
	"\x10SaveAssetRequest\x12\"\n" +
	"\rmedia_file_id\x18\x01 \x01(\rR\vmediaFileId\x12\x1d\n" +
	"\n" +
	...
	"\bmetadata\x18\b \x03(\v2&.plugin.SaveAssetRequest.MetadataEntryR\bmetadata\x1a;\n" +
...
var file_internal_plugins_proto_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
