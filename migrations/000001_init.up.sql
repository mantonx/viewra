-- ViewRA Media Server - Consolidated Schema
-- All timestamps use DATETIME for consistent sqlc type generation (time.Time)
-- All booleans use INTEGER (0/1) for SQLite compatibility
