...
var SystemSettingDefinitions = []Definition{
	...
	{
		Key:         "ai.ollama_embedding_model",
		Type:        TypeString,
		Category:    CategoryAI,
		Label:       "Ollama Embedding Model",
		Description: "Ollama model for embeddings (e.g., nomic-embed-text)",
	...
	{
		Key:         "ai.ollama_chat_model",
		Type:        TypeString,
		Category:    CategoryAI,
		Label:       "Ollama Chat Model",
		Description: "Ollama model for chat (e.g., llama3.2)",
		Default:     "llama3.2",
		EnvVar:      "OLLAMA_CHAT_MODEL",
		AdminOnly:   true,
		Restartable: true,
	},
	...
	{
		Key:         "ai.voyage_embedding_model",
		Type:        TypeString,
		Category:    CategoryAI,
		Label:       "Voyage AI Embedding Model",
		Description: "Voyage AI model for embeddings",
		Default:     "voyage-3-lite",
		EnvVar:      "VOYAGE_EMBEDDING_MODEL",
		AdminOnly:   true,
		Restartable: true,
	},
