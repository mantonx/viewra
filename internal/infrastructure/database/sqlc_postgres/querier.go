...
type Querier interface {
	...
	ListDistinctMovieGenres(ctx context.Context, dollar_1 int64) ([]string, error)
	...
	ListRecentlyAddedMovies(ctx context.Context, dollar_1 int64) ([]ListRecentlyAddedMoviesRow, error)
