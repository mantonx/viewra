...
SELECT id, name, sort_name, photo_path, photo_url, imdb_id, tmdb_id, created_at, updated_at FROM people WHERE imdb_id = $1
`
...
SELECT id, name, sort_name, photo_path, photo_url, imdb_id, tmdb_id, created_at, updated_at FROM people WHERE name = $1 LIMIT 1
`
