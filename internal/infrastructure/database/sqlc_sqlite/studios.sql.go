...
SELECT id, name, logo_path, tmdb_id, created_at FROM studios WHERE id = ?
`
...
SELECT id, name, logo_path, tmdb_id, created_at FROM studios WHERE name = ?
`
...
SELECT id, name, logo_path, tmdb_id, created_at FROM studios WHERE tmdb_id = ?
`
