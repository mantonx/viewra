// Package storage provides disk space checking and size estimation utilities
// for the transcoding system.
package storage
...
// Info contains storage space information.
type Info struct {
	TotalBytes     uint64
	FreeBytes      uint64
...
// GetInfo returns storage information for the given path.
