...
func testWorkerDeps(checkpointRepo *mocks.CheckpointRepository, scanStateRepo *mocks.ScanStateRepository) *Deps {
	return &Deps{
...
func TestUpdateCheckpointStatus(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			deps := testWorkerDeps(checkpointRepo, nil)

			gotAbort := UpdateCheckpointStatus(
				context.Background(),
				deps,
				tt.checkpoint,
				tt.status,
...
func TestHandleCheckpointWarning(t *testing.T) {
	tests := []struct {
		name        string
		setupRepo   func(*mocks.CheckpointRepository)
		checkpoint  *scanner.ScanCheckpoint
...
func TestHandleCheckpointError(t *testing.T) {
	tests := []struct {
		name       string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			deps := testWorkerDeps(checkpointRepo, scanStateRepo)
...
func TestRetryCheckpoint(t *testing.T) {
	tests := []struct {
		name       string
		setupRepo  func(*mocks.CheckpointRepository)
		checkpoint *scanner.ScanCheckpoint
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			go func() {
				RetryCheckpoint(ctx, deps, tt.checkpoint, tt.err, tt.maxRetries)
				close(done)
			}()
...
func TestProcessCheckpointWorker_EarlyAbort(t *testing.T) {
	tests := []struct {
		name        string
		setupRepos  func(*mocks.CheckpointRepository, *mocks.ScanStateRepository)
		lib         *library.Library
