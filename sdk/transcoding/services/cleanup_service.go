...
import (
	...
	"github.com/mantonx/viewra/sdk/transcoding/config"
)
...
func (s *cleanupService) CleanupExpiredSessions() (*CleanupInfo, error) {
...
func (s *cleanupService) GetCleanupStats() (*CleanupInfo, error) {
	info := &CleanupInfo{
		LastCleanup: time.Now(),
	}
