  ...
  return (
    <div ref={dropdownRef} className={`relative ${className}`}>
      ...
      <button
        ...
        className="w-full px-3 py-2.5 min-h-11 text-left bg-white border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 flex items-center justify-between hover:bg-gray-50 transition-colors"
            ...
            {SORT_OPTIONS.map((option) => {
              ...
              return (
                <button
                  ...
                  className={`w-full px-4 py-2.5 min-h-11 text-left text-sm hover:bg-gray-50 flex items-center justify-between transition-colors ${
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={`min-h-8 min-w-8 flex items-center justify-center rounded hover:bg-gray-200 transition-colors ${
