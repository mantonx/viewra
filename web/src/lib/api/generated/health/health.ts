...
import type {
  InternalApiHandlersHealthResponse
} from '.././models';
...
export const getGetHealthQueryOptions = <TData = Awaited<ReturnType<typeof getHealth>>, TError = InternalApiHandlersHealthResponse>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getHealth>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {
...
export function useGetHealth<TData = Awaited<ReturnType<typeof getHealth>>, TError = InternalApiHandlersHealthResponse>(
