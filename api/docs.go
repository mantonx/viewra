...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/admin/scheduler/executions/running": {
            "get": {
                "produces": [
                    "application/json"
                ],
        ...
        "/api/admin/scheduler/executions/{id}/cancel": {
            "post": {
                "produces": [
                    "application/json"
                ],
        ...
        "/api/admin/scheduler/tasks/{id}/disable": {
            "post": {
                "produces": [
                    "application/json"
                ],
        ...
        "/api/admin/scheduler/tasks/{id}/enable": {
            "post": {
                "produces": [
                    "application/json"
                ],
        ...
        "/api/admin/scheduler/tasks/{id}/schedule": {
            "put": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handlers.UpdateScheduleRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/admin/scheduler/tasks/{id}/trigger": {
            "post": {
                "produces": [
                    "application/json"
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handlers.WeatherContextResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/enrichment/bulk-enqueue": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Bulk enqueue request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handlers.BulkEnqueueRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        "description": "Accepted",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handlers.BulkEnqueueResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/enrichment/prioritize": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Prioritize request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handlers.PrioritizeRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handlers.PrioritizeResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handlers.RetryJobRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_mantonx_viewra_internal_application_enrichment_pipeline.CircuitBreakerStatus"
                            }
                        }
                    }
                }
        ...
        "/api/enrichment/stages/{stage}/reset": {
            "post": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handlers.LibraryEnrichmentFailuresResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/libraries/{id}/enrichment/failures/retry": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handlers.RetryLibraryFailuresResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/media/{id}/ffmpeg-logs/{session_id}": {
            "get": {
        ...
        "/api/media/{id}/ffmpeg-logs/{session_id}/info": {
            "get": {
        ...
        "/api/media/{id}/ffmpeg-logs/{session_id}/stream": {
            "get": {
        ...
        "/api/media/{id}/hls/{quality}/playlist.m3u8": {
            "get": {
        ...
        "/api/media/{id}/hls/{quality}/{filename}": {
            "get": {
        ...
        "/api/media/{id}/transcode/{quality}": {
            "get": {
        ...
        "/api/media/{id}/transcode/{quality}/cancel": {
            "post": {
        ...
        "/api/progress/{id}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Device profile hash (e.g., 'chrome-h264-sdr') for device-specific preferences",
                        "name": "device_profile",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "description": "Filter by media types (movie, tv_show, tv_episode)",
                        "name": "types",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_mantonx_viewra_internal_domain_search.Response"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handlers.LocationPreferencesResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handlers.UpdateLocationPreferencesRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_mantonx_viewra_internal_application_enrichment_pipeline.CircuitBreakerStatus": {
            "type": "object",
            "properties": {
                ...
                "state": {
                    "$ref": "#/definitions/github_com_mantonx_viewra_internal_application_enrichment_pipeline.CircuitState"
                }
            }
        },
        "github_com_mantonx_viewra_internal_application_enrichment_pipeline.CircuitState": {
            "type": "string",
            "enum": [
                "closed",
                "open",
        ...
        "github_com_mantonx_viewra_internal_application_library.LibraryResponse": {
            ...
            "properties": {
                ...
                "monitoring_config": {
                    "$ref": "#/definitions/github_com_mantonx_viewra_internal_domain_library.MonitoringConfig"
                },
                "monitoring_enabled": {
                    "type": "boolean"
                },
        ...
        "github_com_mantonx_viewra_internal_application_music.AlbumSummary": {
            ...
            "properties": {
                ...
                "artist_id": {
                    "description": "Artist entity ID for navigation",
                    "type": "integer"
                },
                "id": {
                    "description": "Album entity ID",
                    "type": "integer"
                },
                "track_count": {
                    "type": "integer"
        ...
        "github_com_mantonx_viewra_internal_application_plugins.PluginDetail": {
            ...
            "properties": {
                ...
                "meta": {
                    "description": "x-viewra-meta from settings schema",
                    "type": "object",
                    "additionalProperties": {}
                },
                "missing_dependencies": {
                    "description": "Dependencies this plugin requires but are not currently available\nUsed to show warnings in the UI about missing capabilities",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "provider_id": {
                    "description": "Provider ID if this is a provider plugin (e.g., \"ollama\")",
                    "type": "string"
                },
                "restart_count": {
                    "type": "integer"
        ...
        "github_com_mantonx_viewra_internal_application_plugins.PluginSummary": {
            ...
            "properties": {
                ...
                "capabilities": {
                    "description": "Capabilities this plugin provides (e.g., \"semantic_search\", \"embedding\", \"chat\")",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "github_com_mantonx_viewra_internal_application_progress.UpdateProgressRequest": {
            ...
            "properties": {
                "device_profile": {
                    "description": "Device profile for device-specific preferences (e.g., \"chrome-h264-sdr\", \"firefox-h264h265-hdr\")\nIf provided, preferences are stored per-device; otherwise stored globally",
                    "type": "string"
                },
                "duration_seconds": {
                    "type": "number"
        ...
        "github_com_mantonx_viewra_internal_domain_library.MonitoringConfig": {
            "type": "object",
            "properties": {
                "debounce_seconds": {
                    "description": "DebounceSeconds is the window to collect events before processing\nto handle bulk file operations (default: 5)",
                    "type": "integer"
                },
                "polling_interval_minutes": {
                    "description": "PollingIntervalMinutes is the interval for polling-based monitoring\non network drives where fsnotify doesn't work (default: 60)",
                    "type": "integer"
                },
                "priority": {
                    "description": "Priority for enrichment queue (default: 1000 = PriorityInteractive)",
                    "type": "integer"
                }
            }
        },
        "github_com_mantonx_viewra_internal_domain_search.Response": {
            "type": "object",
            "properties": {
                "fallback": {
                    "description": "True if using fallback search (no semantic search plugin)",
                    "type": "boolean"
                },
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_mantonx_viewra_internal_domain_search.Result"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "github_com_mantonx_viewra_internal_domain_search.Result": {
            "type": "object",
            "properties": {
                "id": {
                    "description": "Entity ID (media_id for movies, show_id for TV shows)",
                    "type": "integer",
                    "format": "int64"
                },
                "libraryID": {
                ...
                "mediaType": {
                    "description": "\"movie\", \"tv_show\", \"tv_episode\", \"music_artist\", \"music_album\", \"music_track\"",
                    "type": "string"
                },
                "score": {
        ...
        "internal_api_handlers.BulkEnqueueRequest": {
            "type": "object",
            "required": [
                "library_id",
                "media_type",
            ...
            "properties": {
                ...
                "stage": {
                    "description": "metadata, images, etc.",
                    "type": "string"
                }
            }
        },
        "internal_api_handlers.BulkEnqueueResponse": {
            "type": "object",
            "properties": {
                "enqueued_count": {
                    "type": "integer"
        ...
        "internal_api_handlers.CircuitBreakerStatusResponse": {
            "type": "object",
            "properties": {
                "consecutive_failures": {
                    "type": "integer"
        ...
        "internal_api_handlers.EnrichmentFailureResponse": {
            "type": "object",
            "properties": {
                "attempts": {
                    "type": "integer"
        ...
        "internal_api_handlers.LibraryEnrichmentFailuresResponse": {
            "type": "object",
            "properties": {
                "failures": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api_handlers.EnrichmentFailureResponse"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "internal_api_handlers.LibraryEnrichmentProgressResponse": {
            ...
            "properties": {
                "circuit_breakers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api_handlers.CircuitBreakerStatusResponse"
                    }
                },
                "current_item": {
                ...
                "eta_seconds": {
                    "description": "Estimated time to completion in seconds, 0 if unknown",
                    "type": "integer"
                },
                "is_active": {
                    "type": "boolean"
        ...
        "internal_api_handlers.LocationPreferencesResponse": {
            "type": "object",
            "properties": {
                "enabled": {
                    "type": "boolean"
        ...
        "internal_api_handlers.PrioritizeRequest": {
            "type": "object",
            "required": [
                "library_id",
                "media_id",
            ...
            "properties": {
                ...
                "media_type": {
                    "description": "movie, tv, tv_show, music, etc.",
                    "type": "string"
                }
            }
        },
        "internal_api_handlers.PrioritizeResponse": {
            "type": "object",
            "properties": {
                "media_id": {
                    "type": "integer"
                ...
                "status": {
                    "description": "\"boosted\", \"enqueued\", or \"already_complete\"",
                    "type": "string"
                }
            }
        },
        ...
        "internal_api_handlers.RetryJobRequest": {
            "type": "object",
            "required": [
                "job_id"
            ],
        ...
        "internal_api_handlers.RetryLibraryFailuresResponse": {
            "type": "object",
            "properties": {
                "retried_count": {
                    "type": "integer"
        ...
        "internal_api_handlers.UpdateLocationPreferencesRequest": {
            "type": "object",
            "properties": {
                "enabled": {
                    "type": "boolean"
        ...
        "internal_api_handlers.UpdateScheduleRequest": {
            "type": "object",
            "required": [
                "schedule"
            ],
        ...
        "internal_api_handlers.WeatherContextResponse": {
            "type": "object",
            "properties": {
                "available": {
                    "type": "boolean"
